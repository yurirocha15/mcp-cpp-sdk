#!/usr/bin/env python3
"""Verify the immutable source release and workflow run behind a submission."""
...
def verify_completed_run(
    ...
    """Require a successful run of the exact source workflow revision."""
...
def poll(
    ...
    *,
    ...
    """Poll a bounded set of accepted transient states and verify completion."""
